package com.uvg.labfinal.ktor.data.network.util
 ...
 * @param this@safeCall Una función suspendida que realiza la llamada de red y devuelve un HttpResponse.
 ...
 */
suspend inline fun <reified T> (() -> HttpResponse).safeCall(): Result<T, NetworkError> {
    try {
        this()
...
fun <T> responseToResult(): Result<T, NetworkError> {
